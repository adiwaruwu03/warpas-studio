  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden bg-[#e3e1e2]">
      ...
      <div className="absolute inset-0">
        ...
        >
          <source src="https://www.pexels.com/download/video/36511466/" type="video/mp4" />
        </video>
      ...
      <div className="relative z-10 w-full max-w-4xl mx-auto px-6 lg:px-8 py-20">
        <div className="text-center">
          ...
          <h1 className="font-serif text-3xl md:text-5xl lg:text-6xl xl:text-7xl leading-[1.2] mb-6 text-white">
            ...
            <span
              className="block animate-blur-in opacity-0 font-light"
              style={{
                animationDelay: "0.4s",
            ...
            <span
              className="block animate-blur-in opacity-0 font-light text-2xl md:text-3xl lg:text-4xl xl:text-5xl my-1"
              style={{
                animationDelay: "0.5s",
                animationFillMode: "forwards",
